...
| 1.9  | Moank processes issuer | Moank Team | Moank evaluates issuer (internal checks - not detailed here, see [ISSUER_ONBOARDING_QA_CHECKLIST.md](./ISSUER_ONBOARDING_QA_CHECKLIST.md)) | ⬜ | |
